...
def generate(gps_location, plants_list, land_size, requested_carbon_credits, time_frame):
    ...
    # Collecting all responses into a list
    responses = []
    response_stream = prompt.generate_content(
...
def main(api_key):
    ...
    # Debug: Print details before calling generate
    print("Calling generate with:")
    print("GPS Location:", [lat, lon])
    print("Plants List:", plants_list_for_ai)
    print("Land Size:", land_size)
    print("Requested Carbon Credits:", requested_carbon_credits)
